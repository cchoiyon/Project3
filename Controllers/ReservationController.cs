...
using Project3.Models.Domain; // For Reservation domain model if used elsewhere
using Project3.Models.DTOs;// Add using for your API DTOs (assuming CreateReservationDto is here)
...
using static Project3.Controllers.API.ReservationsApiController;
...
namespace Project3.Controllers
{
    ...
    public class ReservationController : Controller
    {
        ...
        public async Task<IActionResult> Create(ReservationViewModel model) // Receives data from the form
        {
            ...
            // TODO: Define CreateReservationDto in Models/DTOs folder
            // Map data from the ViewModel (form input) to the DTO the API expects
            var reservationDto = new CreateReservationDto // *** FIXED: Use CreateReservationDto ***
            {
            ...
            try
            {
                ...
                {
                    // TODO: Define ErrorResponseDto in Models/DTOs
