...
using Project3.Shared.Models.Domain; // Updated to use Shared project
using Project3.Shared.Models.ViewModels; // Updated to use Shared project
// using Project3.Shared.Models.DTOs; // Add using for your DTOs
using Project3.Shared.Utilities; // Updated to use Shared project
using System;
...
using Project3.Shared.Models.InputModels; // Updated to use Shared project

namespace Project3.API.Controllers // Updated namespace
{
